// Example configuration based on an Elementic ESP8266 ESP-12E project.
...
const int device_type = 20; // NodeMCU v2/v3
...
const char factoryhostname[] = "esp8266-esp12e-example";
